...
- **音源去哪找？** 两种方式：
  1. 网上搜集：搜索「洛雪自定义音源」可找到各类 `.js` 聚合音源分享帖
  2. **推荐仓库**：[guoyue2010/lxmusic-](https://github.com/guoyue2010/lxmusic-)——作者维护的洛雪自定义音源合集，内含按版本整理的素材（`V2603` 等目录 + `yinyuan.zip`），可从最新目录中挑选 `.js` 音源导入
